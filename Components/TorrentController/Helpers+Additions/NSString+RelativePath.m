...
{
//    return [self relativePathFromBaseDirPath:[[(AppDelegate*)[UIApplication sharedApplication].delegate torrentController] documentsDirectory]];
    return [self relativePathFromBaseDirPath: [[Controller sharedController] documentsDirectory]];
}

- (NSString *)absolutePathFromDocumentDirectory
{
//    return [self absolutePathFromBaseDirPath:[[(AppDelegate*)[UIApplication sharedApplication].delegate torrentController] documentsDirectory]];
    return [self absolutePathFromBaseDirPath: [[Controller sharedController] documentsDirectory]];
}
